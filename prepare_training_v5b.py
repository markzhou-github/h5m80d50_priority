...
Design:
  ...
  - dense per-stock price/turnover time-series features are computed with Polars
  - source-specific compatibility adapters remain per-stock before panel merge
...
EPS = 1e-9
RETURN_DIVERGENCE_STABILIZER = 1e-4
...
MINUTE_FEATURE_BUCKET_CACHE_MAX = 2
...
BASE_FEATURE_LAGS: dict[str, list[int]] = {
    ...
    "vwap_ret_3": [],
    "vwap_ret_5": [],
    "vwap_close_ret_spread_1": [],
    "vwap_close_ret_spread_2": [],
    "vwap_close_ret_spread_3": [],
    "vwap_close_ret_spread_5": [],
    "close_position_10": [],
    "ret_1_log_accel_1": [],
    "ret_1_log_accel_1_z20": [],
    "volume_vs_adv20_position_5": [],
    "close_accel_volume_interaction_10_5": [],
    "open_ret_1_log": [],
    "oc_abs_ret_std_5": [],
    "oc_ret_scaled_5": [],
    "open_close_ret_corr_10": [],
    "open_vs_prev_high": [],
    "open_vs_prev_close": [],
    "open_vs_prev_low": [],
    "open_position_prev_range": [],
    "open_prev_range_interaction": [],
    "close_vs_prev_high": [],
    "close_vs_prev_close": [],
    "close_vs_prev_low": [],
    "close_position_prev_range": [],
    "close_prev_range_interaction": [],
    "range_position_change": [],
    "ma2_ma8_z": [],
    "ma2_above_ma8_std": [],
    "ma2_below_ma8_std": [],
    "volume_above_adv20": [],
    "high_turnover_corr_5": [],
    "high_turnover_corr_5_delta_5": [],
    "ret_volatility_20": [],
    "high_vs_ma20_z": [],
    "return_high_rejection_liquidity": [],
    "high_turnover_corr_5_max_3": [],
    "ret_direction_balance_3": [],
    "volume_intensity_5_20": [],
    "direction_volume_interaction_3_20": [],
    # Alpha101-inspired compact interactions. These already contain trailing
    # history, so they intentionally do not receive automatic lag copies.
    "ret_vol_ratio_2_5": [],
    "ret_vol_ratio_5_20": [],
    "range_geomean_vwap_gap": [],
    "close_position_hl_12": [],
    "close_position_hl_turnover_corr_6": [],
    "low_min_5_change_5": [],
    "close_range_imbalance": [],
    "close_range_imbalance_turnover": [],
    "vwap_turnover_corr_5": [],
    "vwap_turnover_corr_5_ind_resid": [],
    "days_since_close_high_30": [],
    "vwap_gap_high_age_interaction": [],
    "high_volatility_turnover_corr_10": [],
    "range_to_price": [],
    "range_to_price_z20": [],
    "range_shock_turnover": [],
    "ewm_vwap_turnover_corr_5": [],
    "ewm_close_range_imbalance": [],
    "ewm_high_turnover_corr_5": [],
    "oc_ret": LAGS_FAST,
    ...
    "turnover_log_delta_1": [],
    "turnover_log_delta_2": [],
    "turnover_log_delta_3": [],
    "oc_turnover_corr_6": [],
    "open_turnover_corr_5": [],
    "open_turnover_corr_10": [],
    "ret_turnover_cov_5": [],
    "ret_turnover_cov_10": [],
    "ret_turnover_corr_5": [],
    "ret_turnover_corr_10": [],
    "volume_vs_adv20": [],
    "ret_1_min_5": [],
    "ret_1_max_5": [],
    "all_up_5": [],
    "all_down_5": [],
    "daily_trend_regime_5": [],
    "trend_adjusted_ret_4": [],
    "vwap_gap_max_3": [],
    "vwap_gap_min_3": [],
    "turnover_log_delta_3_z20": [],
    "vwap_close_spread_turnover_interaction_3": [],
    "high_turnover_corr_3_sum_3": [],
    ...
    "ret_1_abs_div_csi1500_ew": LAGS_TREND,
    "ret_1_signed_div_csi1500_ew": LAGS_TREND,
    "ret_1_abs_div_csi1500_mcap": LAGS_TREND,
    "ret_1_signed_div_csi1500_mcap": LAGS_TREND,
    ...
    "mkt_breadth_ma3": LAGS_SLOW,
    "mkt_breadth_ma5": LAGS_SLOW,
    "mkt_breadth_accel_1": LAGS_SLOW,
    "mkt_breadth_accel_3": LAGS_SLOW,
    "mkt_ew_mcap_ret_spread": LAGS_SLOW,
    "mkt_ew_mcap_direction_agreement": LAGS_SLOW,
...
#    "hsi_vol_z": LAGS_SLOW,
    ...
    "global_us_ret_mean": LAGS_SLOW,
    "global_asia_ret_mean": LAGS_SLOW,
    "global_risk_ret_mean": LAGS_SLOW,
    "global_ret_dispersion": LAGS_SLOW,
    "global_us_direction_spread": LAGS_SLOW,
    "global_asia_direction_spread": LAGS_SLOW,
    "global_china_return_alignment": LAGS_SLOW,
    "global_china_direction_agreement": LAGS_SLOW,
    "global_us_china_return_alignment": LAGS_SLOW,
    "global_us_china_direction_agreement": LAGS_SLOW,
...
#    "fd_ratio_log_delta_2": LAGS_SHOCK,
    ...
    "ret_1_abs_div_sw_l2": LAGS_TREND,
    "ret_1_signed_div_sw_l2": LAGS_TREND,
 ...
 #   "stock_ind_strength_20": LAGS_MED,
    ...
    # Internal direction of the stock members in each SW L2 industry.
    "sw_l2_member_up_ratio": LAGS_SLOW,
    "sw_l2_member_down_ratio": LAGS_SLOW,
    "sw_l2_member_breadth_spread": LAGS_SLOW,
    "sw_l2_member_gt2_ratio": LAGS_SLOW,
    "sw_l2_member_ltminus2_ratio": LAGS_SLOW,
    "sw_l2_member_tail_spread": LAGS_SLOW,
    "sw_l2_member_ew_ret": LAGS_SLOW,
    "sw_l2_member_ret_dispersion": LAGS_SLOW,
    "sw_l2_member_amount_weighted_ret": LAGS_SLOW,
    "sw_l2_member_breadth_accel_1": LAGS_SLOW,
    "sw_l2_member_breadth_accel_3": LAGS_SLOW,
    "sw_l2_member_breadth_return_alignment": LAGS_SLOW,
    "stock_sw_l2_direction_alignment": LAGS_SLOW,
...
def normalized_return_divergence(
    stock_return: pd.Series,
    benchmark_return: pd.Series,
    *,
    absolute: bool,
    stabilizer: float = RETURN_DIVERGENCE_STABILIZER,
) -> pd.Series:
    stock = pd.to_numeric(stock_return, errors="coerce")
    benchmark = pd.to_numeric(benchmark_return, errors="coerce")
    numerator = stock - benchmark
    if absolute:
        numerator = numerator.abs()
    denominator = stock.abs() + benchmark.abs() + stabilizer
...
def add_core_timeseries_features_polars(frame: pd.DataFrame) -> pd.DataFrame:
    """Calculate the dense per-stock price/turnover block with Polars."""

    df = pl.from_pandas(frame, nan_to_null=True)
    ...
    def safe_ratio(numerator: pl.Expr, denominator: pl.Expr) -> pl.Expr:
        return (
            pl.when(denominator.is_not_null() & (denominator.abs() > EPS))
            .then(numerator / denominator)
            .otherwise(None)
        )

    def rolling_z(expr: pl.Expr, window: int) -> pl.Expr:
        mean = expr.rolling_mean(window_size=window, min_samples=window)
        std = expr.rolling_std(window_size=window, min_samples=window, ddof=0)
    ...
    if "vwap" in df.columns:
        vwap_adj = num("vwap") * adj
    else:
        vwap_adj = safe_ratio(num("amount"), num("vol")) * adj

    df = df.with_columns(
        (num("open") * adj).alias("open_adj"),
        (num("high") * adj).alias("high_adj"),
        (num("low") * adj).alias("low_adj"),
        (num("close") * adj).alias("close_adj"),
        vwap_adj.alias("vwap_adj"),
    )

    close_log = num("close_adj").replace(0.0, None).log()
    open_log = num("open_adj").replace(0.0, None).log()
    high_log = num("high_adj").replace(0.0, None).log()
    low_log = num("low_adj").replace(0.0, None).log()
    vwap_log = num("vwap_adj").replace(0.0, None).log()

    df = df.with_columns(
        (num("pct_chg") / 100.0).alias("ret_1"),
        close_log.diff(1).alias("ret_1_log"),
        *[close_log.diff(window).alias(f"ret_{window}") for window in [2, 3, 5, 10, 20]],
        *[high_log.diff(window).alias(f"high_ret_{window}") for window in [1, 2, 3, 5]],
        *[low_log.diff(window).alias(f"low_ret_{window}") for window in [1, 2, 3, 5]],
        *[vwap_log.diff(window).alias(f"vwap_ret_{window}") for window in [1, 2, 3, 5]],
        open_log.diff(1).alias("open_ret_1_log"),
    )
    df = df.with_columns(
        *[
            (
                pl.col(f"vwap_ret_{window}")
                - pl.col("ret_1_log" if window == 1 else f"ret_{window}")
            ).alias(f"vwap_close_ret_spread_{window}")
            for window in [1, 2, 3, 5]
        ],
        safe_ratio(num("close_adj") - num("open_adj"), num("open_adj")).alias("oc_ret"),
        safe_ratio(num("high_adj") - num("close_adj"), num("close_adj")).alias("close_to_high"),
        safe_ratio(num("close_adj") - num("low_adj"), num("close_adj")).alias("close_to_low"),
        safe_ratio(num("close_adj") - num("vwap_adj"), num("vwap_adj")).alias("vwap_close_ratio"),
        safe_ratio(num("high_adj") - num("vwap_adj"), num("vwap_adj")).alias("vwap_high_ratio"),
        pl.min_horizontal(
            safe_ratio(num("low_adj") - num("vwap_adj"), num("vwap_adj")),
            pl.lit(0.0),
        ).alias("vwap_low_ratio"),
        *[vwap_log.diff(window).alias(f"vwap_log_ret_{window}") for window in [2, 3, 5, 10, 20]],
    )

    prev_high = num("high_adj").shift(1)
    prev_close = num("close_adj").shift(1)
    prev_low = num("low_adj").shift(1)
    prev_range = prev_high - prev_low
    prev_range_scale = prev_range.abs() + EPS
    open_vs_prev_high = (num("open_adj") - prev_high) / prev_range_scale
    open_vs_prev_close = (num("open_adj") - prev_close) / prev_range_scale
    open_vs_prev_low = (num("open_adj") - prev_low) / prev_range_scale
    close_vs_prev_high = (num("close_adj") - prev_high) / prev_range_scale
    close_vs_prev_close = (num("close_adj") - prev_close) / prev_range_scale
    close_vs_prev_low = (num("close_adj") - prev_low) / prev_range_scale
    open_position_prev_range = (num("open_adj") - prev_low) / prev_range_scale
    close_position_prev_range = (num("close_adj") - prev_low) / prev_range_scale
    df = df.with_columns(
        open_vs_prev_high.alias("open_vs_prev_high"),
        open_vs_prev_close.alias("open_vs_prev_close"),
        open_vs_prev_low.alias("open_vs_prev_low"),
        open_position_prev_range.alias("open_position_prev_range"),
        (
            open_vs_prev_high * open_vs_prev_close * open_vs_prev_low
        ).alias("open_prev_range_interaction"),
        close_vs_prev_high.alias("close_vs_prev_high"),
        close_vs_prev_close.alias("close_vs_prev_close"),
        close_vs_prev_low.alias("close_vs_prev_low"),
        close_position_prev_range.alias("close_position_prev_range"),
        (
            close_vs_prev_high * close_vs_prev_close * close_vs_prev_low
        ).alias("close_prev_range_interaction"),
        (close_position_prev_range - open_position_prev_range).alias(
            "range_position_change"
        ),
    )

    df = df.with_columns(
        (pl.col("ret_3") - pl.col("ret_10")).alias("ret_3_minus_ret_10"),
        (pl.col("ret_5") - pl.col("ret_20")).alias("ret_5_minus_ret_20"),
        (pl.col("vwap_log_ret_3") - pl.col("vwap_log_ret_10")).alias("vwap_log_ret_3_minus_10"),
        (pl.col("ret_1") - pl.col("ret_5") / 5.0).alias("ret_1_minus_ret_5_avg"),
        rolling_z(num("vwap_adj"), 60).alias("vwap_z"),
        rolling_z(pl.col("vwap_close_ratio"), 20).alias("vwap_close_z"),
        safe_ratio(
            (num("high_adj") - num("low_adj")).abs(),
            num("close_adj"),
        ).alias("true_range_pct"),
    )
    df = df.with_columns(
        rolling_z(pl.col("true_range_pct"), 20).alias("true_range_pct_z"),
        *[
            pl.col("true_range_pct").rolling_mean(window_size=window).alias(
                f"true_range_mean_{window}"
            )
            for window in [5, 10, 20]
        ],
        *[
            pl.col("ret_1").rolling_std(window_size=window, ddof=0).alias(
                f"ret_std_{window}"
            )
            for window in [5, 10, 20]
        ],
    ...
    df = df.with_columns(
        *[
            rolling_z(pl.col(f"true_range_mean_{window}"), 60).alias(
                f"true_range_mean_{window}_z"
            )
            for window in [5, 10, 20]
        ],
        *[
            rolling_z(pl.col(f"ret_std_{window}"), 60).alias(f"ret_std_{window}_z")
            for window in [5, 10, 20]
        ],
    )
    df = df.with_columns(
        safe_ratio(
            (num("close_adj") - num("vwap_adj")) / num("close_adj"),
            pl.col("true_range_mean_20"),
        ).alias("vwap_imbalance"),
        rolling_z(num("vol"), 60).alias("vol_z"),
        rolling_z(num("amount"), 60).alias("amount_z"),
    )

    close_min_10 = close_log.rolling_min(window_size=10)
    close_max_10 = close_log.rolling_max(window_size=10)
    close_position_10 = safe_ratio(
        close_log - close_min_10,
        close_max_10 - close_min_10,
    )
    low_min_12 = num("low_adj").rolling_min(window_size=12, min_samples=12)
    high_max_12 = num("high_adj").rolling_max(window_size=12, min_samples=12)
    close_position_hl_12 = safe_ratio(
        num("close_adj") - low_min_12,
        high_max_12 - low_min_12,
    )
    low_min_5 = num("low_adj").rolling_min(window_size=5, min_samples=5)
    low_min_5_change_5 = safe_ratio(low_min_5, low_min_5.shift(5)) - 1.0
    close_range_imbalance = safe_ratio(
        2.0 * num("close_adj") - num("high_adj") - num("low_adj"),
        num("high_adj") - num("low_adj"),
    )
    range_geomean_vwap_gap = (
        safe_ratio(
            (num("high_adj") * num("low_adj")).clip(lower_bound=0.0).sqrt(),
            num("vwap_adj"),
        )
        - 1.0
    )
    range_to_price = safe_ratio(
        num("high_adj") - num("low_adj"),
        num("close_adj"),
    )
    close_high_age_30 = (
        pl.when(close_log.is_not_null().cast(pl.UInt8).rolling_sum(30) == 30)
        .then(
            pl.concat_list(
                [close_log.shift(age) for age in range(30)]
            ).list.arg_max()
        )
        .otherwise(None)
    )
    ret_accel_1 = pl.col("ret_1_log") - pl.col("ret_1_log").shift(1)
    close_ma_2 = close_log.rolling_mean(window_size=2)
    close_ma_8 = close_log.rolling_mean(window_size=8)
    close_std_8 = close_log.rolling_std(window_size=8, ddof=0)
    ma2_ma8_z = (close_ma_2 - close_ma_8) / (close_std_8 + EPS)
    high_ma_20 = high_log.rolling_mean(window_size=20)
    high_std_20 = high_log.rolling_std(window_size=20, ddof=0)
    df = df.with_columns(
        close_position_10.alias("close_position_10"),
        close_position_hl_12.alias("close_position_hl_12"),
        low_min_5_change_5.alias("low_min_5_change_5"),
        close_range_imbalance.alias("close_range_imbalance"),
        range_geomean_vwap_gap.alias("range_geomean_vwap_gap"),
        range_to_price.alias("range_to_price"),
        rolling_z(range_to_price, 20).alias("range_to_price_z20"),
        close_high_age_30.cast(pl.Float64).alias("days_since_close_high_30"),
        ret_accel_1.alias("ret_1_log_accel_1"),
        rolling_z(ret_accel_1, 20).alias("ret_1_log_accel_1_z20"),
        pl.col("oc_ret").abs().rolling_std(window_size=5, ddof=0).alias(
            "oc_abs_ret_std_5"
        ),
        pl.rolling_corr(
            pl.col("open_ret_1_log"),
            pl.col("ret_1_log"),
            window_size=10,
        ).alias("open_close_ret_corr_10"),
        ma2_ma8_z.alias("ma2_ma8_z"),
        (high_log - high_ma_20).truediv(high_std_20 + EPS).alias(
            "high_vs_ma20_z"
        ),
        pl.col("ret_1_log").rolling_std(window_size=20, ddof=0).alias(
            "ret_volatility_20"
        ),
    )
    df = df.with_columns(
        safe_ratio(pl.col("oc_ret"), pl.col("oc_abs_ret_std_5")).alias(
            "oc_ret_scaled_5"
        ),
        pl.when(pl.col("ma2_ma8_z").is_not_null())
        .then((pl.col("ma2_ma8_z") > 1.0).cast(pl.Float64))
        .otherwise(None)
        .alias("ma2_above_ma8_std"),
        pl.when(pl.col("ma2_ma8_z").is_not_null())
        .then((pl.col("ma2_ma8_z") < -1.0).cast(pl.Float64))
        .otherwise(None)
        .alias("ma2_below_ma8_std"),
    )

    log_vol = num("vol").replace(0.0, None).log()
    log_amount = num("amount").replace(0.0, None).log()
    turnover_log = num("turnover_rate_f").clip(lower_bound=0.0).log1p()
    df = df.with_columns(
        *[
            rolling_z(
                log_vol.rolling_std(window_size=window, ddof=0), 60
            ).alias(f"vol_rv_{window}_z")
            for window in [5, 20]
        ],
        *[
            rolling_z(
                log_amount.rolling_std(window_size=window, ddof=0), 60
            ).alias(f"amt_rv_{window}_z")
            for window in [5, 20]
        ],
        turnover_log.alias("turnover_f_log"),
        *[
            turnover_log.diff(window).alias(f"turnover_log_delta_{window}")
            for window in [1, 2, 3]
        ],
    )

    open_ret_1 = safe_ratio(num("open_adj"), num("open_adj").shift(1)) - 1.0
    df = df.with_columns(
        pl.rolling_corr(
            pl.col("oc_ret"), pl.col("turnover_log_delta_2"), window_size=6
        ).alias("oc_turnover_corr_6"),
        pl.rolling_corr(
            open_ret_1, pl.col("turnover_log_delta_1"), window_size=5
        ).alias("open_turnover_corr_5"),
        pl.rolling_corr(
            open_ret_1, pl.col("turnover_log_delta_1"), window_size=10
        ).alias("open_turnover_corr_10"),
        pl.rolling_cov(
            pl.col("ret_1_log"), pl.col("turnover_log_delta_1"), window_size=5
        ).alias("ret_turnover_cov_5"),
        pl.rolling_cov(
            pl.col("ret_1_log"), pl.col("turnover_log_delta_1"), window_size=10
        ).alias("ret_turnover_cov_10"),
        pl.rolling_corr(
            pl.col("ret_1_log"), pl.col("turnover_log_delta_1"), window_size=5
        ).alias("ret_turnover_corr_5"),
        pl.rolling_corr(
            pl.col("ret_1_log"), pl.col("turnover_log_delta_1"), window_size=10
        ).alias("ret_turnover_corr_10"),
        (
            safe_ratio(
                num("vol"),
                num("vol")
            ...
            - 1.0
        ).alias("volume_vs_adv20"),
        pl.col("ret_1_log").rolling_min(window_size=5).alias("ret_1_min_5"),
        pl.col("ret_1_log").rolling_max(window_size=5).alias("ret_1_max_5"),
    )

    volume_position_min_5 = pl.col("volume_vs_adv20").rolling_min(window_size=5)
    volume_position_max_5 = pl.col("volume_vs_adv20").rolling_max(window_size=5)
    volume_position_5 = safe_ratio(
        pl.col("volume_vs_adv20") - volume_position_min_5,
        volume_position_max_5 - volume_position_min_5,
    )
    volume_intensity_5_20 = (
        4.0
        * safe_ratio(
            num("vol").rolling_sum(window_size=5),
            num("vol").rolling_sum(window_size=20),
        )
    )
    direction_sign = (
        pl.when(pl.col("ret_1_log") > 0.0)
        .then(1.0)
        .when(pl.col("ret_1_log") < 0.0)
        .then(-1.0)
        .when(pl.col("ret_1_log").is_not_null())
        .then(0.0)
        .otherwise(None)
    )
    direction_balance_3 = (
        direction_sign + direction_sign.shift(1) + direction_sign.shift(2)
    ) / 3.0
    df = df.with_columns(
        volume_position_5.alias("volume_vs_adv20_position_5"),
        pl.when(pl.col("volume_vs_adv20").is_not_null())
        .then((pl.col("volume_vs_adv20") >= 0.0).cast(pl.Float64))
        .otherwise(None)
        .alias("volume_above_adv20"),
        volume_intensity_5_20.alias("volume_intensity_5_20"),
        direction_balance_3.alias("ret_direction_balance_3"),
    )
    df = df.with_columns(
        (
            (pl.col("close_position_10") - 0.5)
            * pl.col("ret_1_log_accel_1_z20")
            * (pl.col("volume_vs_adv20_position_5") - 0.5)
        ).alias("close_accel_volume_interaction_10_5"),
        (
            pl.col("ret_direction_balance_3")
            * pl.col("volume_intensity_5_20")
        ).alias("direction_volume_interaction_3_20"),
        (
            pl.col("ret_1_log")
            * pl.col("close_to_high")
            * (pl.col("volume_vs_adv20") + 1.0)
        ).alias("return_high_rejection_liquidity"),
        (
            pl.col("vwap_close_ratio")
            * (pl.col("days_since_close_high_30") / 29.0)
        ).alias("vwap_gap_high_age_interaction"),
    )
    ...
    ret_min_4 = pl.col("ret_1_log").rolling_min(window_size=4)
    ret_max_4 = pl.col("ret_1_log").rolling_max(window_size=4)
    valid_4 = (
        pl.col("ret_1_log")
        .is_not_null()
        .cast(pl.UInt8)
    ...
    persistent_4 = (ret_min_4 > 0.0) | (ret_max_4 < 0.0)
    df = df.with_columns(
        pl.when(valid_5)
        .then((pl.col("ret_1_min_5") > 0.0).cast(pl.Float64))
        .otherwise(None)
        .alias("all_up_5"),
        pl.when(valid_5)
        .then((pl.col("ret_1_max_5") < 0.0).cast(pl.Float64))
        .otherwise(None)
        .alias("all_down_5"),
        pl.when(valid_4)
        .then(
            pl.when(persistent_4)
            .then(pl.col("ret_1_log"))
            .otherwise(-pl.col("ret_1_log"))
        )
        .otherwise(None)
        .alias("trend_adjusted_ret_4"),
    )
    complete_vwap_spread_3 = (
        pl.col("vwap_close_ret_spread_1").is_not_null()
        & pl.col("vwap_close_ret_spread_2").is_not_null()
        & pl.col("vwap_close_ret_spread_3").is_not_null()
    )
    df = df.with_columns(
        (pl.col("all_up_5") - pl.col("all_down_5")).alias("daily_trend_regime_5"),
        pl.when(complete_vwap_spread_3)
        .then(
            pl.max_horizontal(
                "vwap_close_ret_spread_1",
                "vwap_close_ret_spread_2",
        ...
        .otherwise(None)
        .alias("vwap_gap_min_3"),
        rolling_z(pl.col("turnover_log_delta_3"), 20).alias(
            "turnover_log_delta_3_z20"
        ),
    )
    high_turnover_corr_5 = pl.rolling_corr(
        pl.col("high_ret_1"),
        pl.col("turnover_f_log"),
        window_size=5,
    )
    close_position_hl_turnover_corr_6 = pl.rolling_corr(
        pl.col("close_position_hl_12"),
        pl.col("turnover_log_delta_1"),
        window_size=6,
    )
    vwap_turnover_corr_5 = pl.rolling_corr(
        pl.col("vwap_ret_1"),
        pl.col("turnover_log_delta_1"),
        window_size=5,
    )
    df = df.with_columns(
        (
            (pl.col("vwap_gap_max_3") + pl.col("vwap_gap_min_3"))
            * pl.col("turnover_log_delta_3_z20")
        ).alias("vwap_close_spread_turnover_interaction_3"),
        pl.rolling_corr(
            pl.col("high_ret_1"),
            pl.col("turnover_log_delta_1"),
            window_size=3,
        ...
        .alias("high_turnover_corr_3_sum_3"),
        finite_or_null(high_turnover_corr_5).alias("high_turnover_corr_5"),
        finite_or_null(close_position_hl_turnover_corr_6).alias(
            "close_position_hl_turnover_corr_6"
        ),
        finite_or_null(vwap_turnover_corr_5).alias("vwap_turnover_corr_5"),
    )
    df = df.with_columns(
        (
            pl.col("high_turnover_corr_5")
            - pl.col("high_turnover_corr_5").shift(5)
        ).alias("high_turnover_corr_5_delta_5"),
        pl.col("high_turnover_corr_5")
        .rolling_max(window_size=3)
        .alias("high_turnover_corr_5_max_3"),
        (
            pl.col("high_ret_1").rolling_std(window_size=10, ddof=0)
            * pl.rolling_corr(
                pl.col("high_ret_1"),
                pl.col("turnover_f_log"),
                window_size=10,
            )
        ).alias("high_volatility_turnover_corr_10"),
        safe_ratio(
            pl.col("ret_1_log").rolling_std(window_size=2, ddof=0),
            pl.col("ret_1_log").rolling_std(window_size=5, ddof=0),
        ).alias("ret_vol_ratio_2_5"),
        safe_ratio(
            pl.col("ret_1_log").rolling_std(window_size=5, ddof=0),
            pl.col("ret_1_log").rolling_std(window_size=20, ddof=0),
        ).alias("ret_vol_ratio_5_20"),
        pl.col("vwap_turnover_corr_5")
        .ewm_mean(span=5, adjust=False, min_samples=3)
        .alias("ewm_vwap_turnover_corr_5"),
        pl.col("close_range_imbalance")
        .ewm_mean(span=5, adjust=False, min_samples=3)
        .alias("ewm_close_range_imbalance"),
        pl.col("high_turnover_corr_5")
        .ewm_mean(span=5, adjust=False, min_samples=3)
        .alias("ewm_high_turnover_corr_5"),
    )

    turnover_mean_20_prior = turnover_log.rolling_mean(window_size=20).shift(1)
    turnover_std_20_prior = turnover_log.rolling_std(
        window_size=20, ddof=0
    ).shift(1)
    turnover_surprise_10 = turnover_log - turnover_log.rolling_mean(
        window_size=10
    ).shift(1)
    turnover_trend = turnover_log.rolling_mean(window_size=5).shift(
        1
    ) - turnover_log.rolling_mean(window_size=20).shift(1)
    df = df.with_columns(
        ((turnover_log - turnover_mean_20_prior) / (turnover_std_20_prior + EPS)).alias(
            "turnover_z_20"
        ),
        turnover_surprise_10.alias("turnover_surprise_10"),
        turnover_trend.alias("turnover_trend_5_20"),
        turnover_trend.diff(1).alias("turnover_accel_5_20"),
        (pl.col("ret_std_5_z") - pl.col("ret_std_20_z")).alias("vol_comp_z"),
    )
    df = df.with_columns(
        (pl.col("turnover_surprise_10") * -pl.col("vol_comp_z")).alias(
            "turnover_in_compression"
        ),
        (
            pl.col("close_range_imbalance")
            * pl.col("turnover_surprise_10")
        ).alias("close_range_imbalance_turnover"),
        (
            pl.col("range_to_price_z20")
            * pl.col("turnover_surprise_10")
        ).alias("range_shock_turnover"),
        (pl.col("turnover_trend_5_20") * -pl.col("vol_comp_z")).alias(
            "pressure_build"
        ),
        (
            pl.col("turnover_z_20")
            * pl.col("vol_comp_z").clip(lower_bound=0.0)
        ).alias("exhaustion_risk"),
        (
            pl.col("turnover_trend_5_20")
            * -(pl.col("true_range_mean_5_z") - pl.col("true_range_mean_20_z"))
        ).alias("turnover_range_pressure"),
    )
...
def prepare_csi1500_features() -> pd.DataFrame:
    ...
    breadth = idx["csi1500_ew_up_ratio"] - idx["csi1500_ew_down_ratio"]
    idx["mkt_breadth_ma3"] = breadth.rolling(3, min_periods=2).mean()
    idx["mkt_breadth_ma5"] = breadth.rolling(5, min_periods=3).mean()
    idx["mkt_breadth_accel_1"] = breadth.diff(1)
    idx["mkt_breadth_accel_3"] = breadth.diff(3)
    idx["mkt_ew_mcap_ret_spread"] = idx["csi1500_ew_ret"] - idx["csi1500_mcap_ret"]
    idx["mkt_ew_mcap_direction_agreement"] = (
        np.sign(idx["csi1500_ew_ret"]) * np.sign(idx["csi1500_mcap_ret"])
    )
    ...
    keep = [
        ...
        "mkt_breadth_ma3", "mkt_breadth_ma5", "mkt_breadth_accel_1",
        "mkt_breadth_accel_3", "mkt_ew_mcap_ret_spread",
        "mkt_ew_mcap_direction_agreement",
...
def prepare_market_features() -> pd.DataFrame:
    ...
    global_returns = [c for c in ["hsi_ret", "hktech_ret", "xin9_ret", "spx_ret", "ixic_ret", "n225_ret"] if c in m]
    us_returns = [c for c in ["spx_ret", "ixic_ret"] if c in m]
    asia_returns = [c for c in ["hsi_ret", "hktech_ret", "xin9_ret", "n225_ret"] if c in m]
    if us_returns:
        m["global_us_ret_mean"] = m[us_returns].mean(axis=1)
        m["global_us_direction_spread"] = np.sign(m[us_returns]).mean(axis=1)
    if asia_returns:
        m["global_asia_ret_mean"] = m[asia_returns].mean(axis=1)
        m["global_asia_direction_spread"] = np.sign(m[asia_returns]).mean(axis=1)
    if global_returns:
        m["global_risk_ret_mean"] = m[global_returns].mean(axis=1)
        m["global_ret_dispersion"] = m[global_returns].std(axis=1, ddof=0)
    ...
    keep = [
        ...
        "n225_ret", "n225_swing", 
        "global_us_ret_mean", "global_asia_ret_mean", "global_risk_ret_mean",
        "global_ret_dispersion", "global_us_direction_spread",
        "global_asia_direction_spread",
    ]
...
def read_minute_features(ts_code: str, minute_feature_source: str | Path) -> pd.DataFrame:
    ...
    if is_minute_bucket_dir(source):
        ...
        if bucket_file not in G_MINUTE_FEATURE_BUCKET_CACHE:
            ...
            while len(G_MINUTE_FEATURE_BUCKET_CACHE) > MINUTE_FEATURE_BUCKET_CACHE_MAX:
                oldest = next(iter(G_MINUTE_FEATURE_BUCKET_CACHE))
                if oldest == bucket_file and len(G_MINUTE_FEATURE_BUCKET_CACHE) > 1:
                    oldest = next(key for key in G_MINUTE_FEATURE_BUCKET_CACHE if key != bucket_file)
                G_MINUTE_FEATURE_BUCKET_CACHE.pop(oldest, None)
...
def process_one_stock(
    ...
    try:
        ...
        s = add_core_timeseries_features_polars(s)
...
# chip data code replaced. 
        ...
        s["global_china_return_alignment"] = s["global_risk_ret_mean"] * s["csi1500_ew_ret"]
        s["global_china_direction_agreement"] = (
            np.sign(s["global_risk_ret_mean"]) * np.sign(s["csi1500_ew_ret"])
        )
        s["global_us_china_return_alignment"] = s["global_us_ret_mean"] * s["csi1500_ew_ret"]
        s["global_us_china_direction_agreement"] = (
            np.sign(s["global_us_ret_mean"]) * np.sign(s["csi1500_ew_ret"])
        )
        ...
        s["ret_1_abs_div_csi1500_ew"] = normalized_return_divergence(
            s["ret_1"], s["csi1500_ew_ret"], absolute=True
        )
        s["ret_1_signed_div_csi1500_ew"] = normalized_return_divergence(
            s["ret_1"], s["csi1500_ew_ret"], absolute=False
        )
        s["ret_1_abs_div_csi1500_mcap"] = normalized_return_divergence(
            s["ret_1"], s["csi1500_mcap_ret"], absolute=True
        )
        s["ret_1_signed_div_csi1500_mcap"] = normalized_return_divergence(
            s["ret_1"], s["csi1500_mcap_ret"], absolute=False
        )
  ...
  #      s["vol_over_csi1500_mcap_vol"] = safe_div(s["ret_std_20"], s["csi1500_mcap_ret_std_20"])
        ...
        s["ret_1_abs_div_sw_l2"] = normalized_return_divergence(
            s["ret_1"], s["sw_l2_ret_1"], absolute=True
        )
        s["ret_1_signed_div_sw_l2"] = normalized_return_divergence(
            s["ret_1"], s["sw_l2_ret_1"], absolute=False
        )
...
def process_stock_chunk(
    ...
    def flush_frames() -> None:
        nonlocal part_no
        if not return_data or not frames:
            return
        part_no += 1
        chunk_path = Path(chunk_out_dir) / f"chunk_{chunk_id:03d}_part_{part_no:04d}.parquet"
    ...
    for i, stock_path in enumerate(stock_paths, 1):
        ...
        if data is not None:
            ...
            if len(frames) >= max(1, flush_stocks):
                flush_frames()
        results.append(res)
        err = res.get("error")
...
def add_cross_sectional_features(panel: pl.DataFrame, sw_rank: pl.DataFrame) -> pl.DataFrame:
    ...
    if "vwap_turnover_corr_5" in panel.columns:
        exprs.append(
            (
                pl.col("vwap_turnover_corr_5")
                - pl.col("vwap_turnover_corr_5").mean().over(
                    ["trade_date", "sw_l2_code"]
                )
            ).alias("vwap_turnover_corr_5_ind_resid")
        )
    if exprs:
    ...
    # Internal SW L2 breadth is computed from constituent stocks after the
    # clean panel is assembled. It therefore reflects only information known
    # by the close of the feature date.
    if {"ret_1", "amount", "sw_l2_code"}.issubset(panel.columns):
        industry_keys = ["trade_date", "sw_l2_code"]
        amount_sum = pl.col("amount").sum().over(industry_keys)
        panel = panel.with_columns(
            (pl.col("ret_1") > 0).cast(pl.Float64).mean().over(industry_keys).alias("sw_l2_member_up_ratio"),
            (pl.col("ret_1") < 0).cast(pl.Float64).mean().over(industry_keys).alias("sw_l2_member_down_ratio"),
            (pl.col("ret_1") >= 0.02).cast(pl.Float64).mean().over(industry_keys).alias("sw_l2_member_gt2_ratio"),
            (pl.col("ret_1") <= -0.02).cast(pl.Float64).mean().over(industry_keys).alias("sw_l2_member_ltminus2_ratio"),
            pl.col("ret_1").mean().over(industry_keys).alias("sw_l2_member_ew_ret"),
            pl.col("ret_1").std(ddof=0).over(industry_keys).alias("sw_l2_member_ret_dispersion"),
            pl.when(amount_sum.abs() > EPS)
            .then((pl.col("ret_1") * pl.col("amount")).sum().over(industry_keys) / amount_sum)
            .otherwise(None)
            .alias("sw_l2_member_amount_weighted_ret"),
        )
        panel = panel.with_columns(
            (pl.col("sw_l2_member_up_ratio") - pl.col("sw_l2_member_down_ratio"))
            .alias("sw_l2_member_breadth_spread"),
            (pl.col("sw_l2_member_gt2_ratio") - pl.col("sw_l2_member_ltminus2_ratio"))
            .alias("sw_l2_member_tail_spread"),
        )
        panel = panel.sort(["sw_l2_code", "ts_code", "trade_date"]).with_columns(
            pl.col("sw_l2_member_breadth_spread").diff(1).over("ts_code")
            .alias("sw_l2_member_breadth_accel_1"),
            pl.col("sw_l2_member_breadth_spread").diff(3).over("ts_code")
            .alias("sw_l2_member_breadth_accel_3"),
            (pl.col("sw_l2_member_breadth_spread") * pl.col("sw_l2_member_ew_ret"))
            .alias("sw_l2_member_breadth_return_alignment"),
            (pl.col("ret_1").sign() * pl.col("sw_l2_member_ew_ret").sign())
            .alias("stock_sw_l2_direction_alignment"),
        )
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="In chunked mode, flush each worker's accumulated frames after this many stocks.",
    )
    parser.add_argument(
    ...
    print(
        "[pipeline] "
        f"workers={args.workers} merge_mode={args.merge_mode} "
        f"finalize_mode={args.finalize_mode} worker_flush_stocks={args.worker_flush_stocks} "
        f"finalize_date_batch_size={args.finalize_date_batch_size} "
        f"downcast_float32={args.downcast_float32} "
        "feature_engine=polars-core",
        flush=True,
    )
    if args.merge_mode == "memory" or args.finalize_mode == "memory":
        warnings.warn(
            "Memory mode can exceed WSL memory on a full build. "
            "Prefer --merge-mode chunked --finalize-mode out-of-core.",
            RuntimeWarning,
        )
        ...
        with ProcessPoolExecutor(
            ...
            futs = [
                ex.submit(
                    ...
                    str(CHUNK_DIR),
                    minute_feature_source_arg,
                    max(1, args.worker_flush_stocks),
                )
            ...
            for i, fut in enumerate(as_completed(futs), 1):
                ...
                chunk_files.extend(Path(path) for path in chunk_res.get("chunk_files", []))
    ...
    summary = {
        ...
        "worker_flush_stocks": args.worker_flush_stocks,
